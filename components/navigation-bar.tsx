...
export function NavigationBar() {
    return (
        <div className="flex items-center justify-between space-y-2">
            <div className="flex">
                <h1 className="tracking-tight transition font-display text-3xl font-bold sm:text-[3rem] bg-gradient-to-r from-20% bg-clip-text text-transparent from-emerald-500 to-yellow-500 dark:from-emerald-400 dark:to-yellow-300">
                    Rakan
                </h1>
